...
Видим, что мы админы. 
Порой для получения доступа к сервисам и кластеру даже не нужно быть внутри контейнера и взламывать сервисы. Давайте откроем в браузере или netcat порт 30003 
```bash
